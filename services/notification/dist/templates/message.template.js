...
exports.newMessageTemplate = void 0;
...
const newMessageTemplate = (d) => ({
    ...
    <a href="${environment_1.env.APP_URL}/messages${d.bookingId ? `?booking=${d.bookingId}` : ""}" class="btn">Reply →</a>`),
});
exports.newMessageTemplate = newMessageTemplate;
