...
exports.incidentEscalatedTemplate = exports.superhostRevokedTemplate = exports.superhostGrantedTemplate = exports.reviewReceivedTemplate = void 0;
...
const reviewReceivedTemplate = (d) => ({
    ...
    <a href="${environment_1.env.APP_URL}/account" class="btn">View My Profile →</a>`),
});
exports.reviewReceivedTemplate = reviewReceivedTemplate;
const superhostGrantedTemplate = (d) => ({
    subject: `🏆 Congratulations — You're a Superhost!`,
    html: base(`
    <h2 style="color:#F59E0B">🏆 You're a Superhost!</h2>
    <p>Hi ${d.hostName},</p>
    <p>Congratulations! You've achieved <strong>Superhost</strong> status on ${environment_1.env.APP_NAME}.</p>
    <p>Your listings will now rank higher in search results and display the Superhost badge.</p>
    <a href="${environment_1.env.APP_URL}/account" class="btn">View My Listings →</a>`),
});
exports.superhostGrantedTemplate = superhostGrantedTemplate;
const superhostRevokedTemplate = (d) => ({
    ...
    <a href="${environment_1.env.APP_URL}/account" class="btn">Improve My Listings →</a>`),
});
exports.superhostRevokedTemplate = superhostRevokedTemplate;
const incidentEscalatedTemplate = (d) => ({
...
exports.incidentEscalatedTemplate = incidentEscalatedTemplate;
